            ...
            <main className="w-full h-screen flex flex-col items-center justify-center sm:px-4"  >
                    <div className=" w-full space-y-6 sm:max-w-md">
                        <div className="text-center">
                                <img src=''  width={150} className="mx-auto" alt="" />
                            <div className="mt-5 space-y-2">
                                <h3 className=" text-2xl font-bold sm:text-3xl">Log in to your account</h3>
                                <p  className="">Don't have an account? <a href="/" className="font-medium text-indigo-600 hover:text-indigo-500"> <Link to='/singup'  > Sign up  </Link>   </a></p>
                            </div>
                        </div>
                        <div className=" shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                            ...
                            <div className="relative">
                                ...
                                <p className="inline-block w-fit text-sm  px-2 absolute -top-2 inset-x-0 mx-auto">Or continue with</p>
                            </div>
                            <form
